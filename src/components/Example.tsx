	...
	return (
		<div className='flex flex-col items-center gap-6 py-4 font-mono'>
			...
			<div className='flex flex-row gap-x-2 text-8xl text-white'>
				<button className='bg-red-500 py-4 px-8' onClick={e => dispatch(decrement())} disabled={value <= -69}>
					-
				</button>
				<button className='bg-blue-500 py-4 px-8' onClick={e => dispatch(increment())} disabled={value >= 69}>
					+
				</button>
			</div>
